package com.sixgod.application.ext;

import com.sixgod.application.job.ChatbotTask;
import com.sixgod.common.PropertyUtil;
...
public class TaskRegistrarAutoConfig implements EnvironmentAware, SchedulingConfigurer {
    ...
    public void configureTasks(ScheduledTaskRegistrar taskRegistrar) {
        ...
        for (String groupKey : taskGroups) {
            ...
            // 添加任务
            taskRegistrar.addCronTask(new ChatbotTask(groupName, groupId, cookie, openAiKey, chatbotApi, openAI), cronExpression);
        }
    }
