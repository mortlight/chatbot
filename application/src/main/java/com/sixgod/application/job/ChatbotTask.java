package com.sixgod.application.job;

import com.alibaba.fastjson.JSON;
import com.sixgod.domain.ai.IOpenAI;
import com.sixgod.domain.chatbot.IChatbotApi;
import com.sixgod.domain.chatbot.model.aggregates.UnAnsweredQuestionsAggregates;
import com.sixgod.domain.chatbot.model.vo.Topics;
...
public class ChatbotTask implements Runnable {
    ...
    private IChatbotApi ChatbotApi;
    private IOpenAI openAI;

    public ChatbotTask(String groupName, String groupId, String cookie, String openAiKey, IChatbotApi ChatbotApi, IOpenAI openAI) {
    ...
    public void run() {
        try {
            ...
            // 1. 检索问题
            UnAnsweredQuestionsAggregates unAnsweredQuestionsAggregates = ChatbotApi.queryUnAnsweredQuestionsTopicId(groupId, cookie);
            ...
            // 3. 问题回复
            boolean status = ChatbotApi.answer(groupId, cookie, topic.getTopic_id(), answer, false);
