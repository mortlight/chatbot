package com.sixgod.domain.chatbot.service;
...
import com.sixgod.domain.chatbot.model.req.AnswerReq;
import com.sixgod.domain.chatbot.model.req.ReqData;
import com.sixgod.domain.chatbot.model.res.AnswerRes;
...
@Service
public class ChatbotApi implements IChatbotApi {

    private Logger logger = LoggerFactory.getLogger(ChatbotApi.class);
